...
def setup_arg_parser():
    parser = argparse.ArgumentParser(description="Run the AI DevOps Crew")
    parser.add_argument("prompt", help="The task description or prompt")
    parser.add_argument("--project", default="default", help="Project identifier (e.g., 'zeroai' or 'cyford/zeroai')")
    parser.add_argument("--category", default="general", help="Task category (developer, documentation, repo_manager, research)")
    parser.add_argument("--task-id", default=None, help="Task ID for tracking (auto-generated if not provided)")
    ...
    parser.add_argument("--dry-run", action="store_true", help="Only simulate execution without making changes")
    return parser
