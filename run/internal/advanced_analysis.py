...
def main():
    ...
    try:
        # Get user choice before initializing the manager
        ...
        for option, topic, description in topics_options:
        ...
        # Initialize the AI Crew Manager, passing the router and topic
        console.print("🔧 Initializing AI Crew Manager...")
        manager = AICrewManager(distributed_router, category="analysis", topic=topic)

        # Create an analysis crew
        console.print("👥 Creating analysis crew (Researcher + Analyst + Writer)...")
        crew = manager.create_analysis_crew({"topic": topic}) # Pass the inputs as a dictionary
