# /app/run/internal/code_generator.py
...
def generate_code(prompt: str):
    """Generate code directly using the optimal model with retry logic."""

    max_retries = 5 # Increase retries for more robust fallback
    failed_peers = []
...
Code:"""
        ...
        except (RuntimeError, litellm.APIConnectionError) as e:
            console.print(f"❌ LLM Call Failed (Attempt {attempt + 1}/{max_retries}): {e}", style="red")

            # Fix: Ensure peer_name is captured for accurate tracking
