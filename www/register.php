    ...
    if (empty($company_name) || empty($first_name) || empty($last_name) || empty($email) || empty($password)) {
        ...
        try {
            ...
            if (!empty($existing)) {
                ...
                $db->query("INSERT INTO users (company_name, first_name, last_name, email, phone, password, role) VALUES (?, ?, ?, ?, ?, ?, 'user')", 
                ...
                <div class="card-body p-4">
                    ...
                    <?php else: ?>
                        ...
                        <div class="text-center mt-3">
                            <p class="text-muted">Already have an account? <a href="/admin/login.php">Login here</a></p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
