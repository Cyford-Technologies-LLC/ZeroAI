...
$systemPrompt .= "- @train_agents - Autonomously analyze logs and improve agents\n";
$systemPrompt .= "- @audit_agents - Check all agent configurations for issues\n";
$systemPrompt .= "- @agent_health - Get comprehensive agent performance report\n\n";
$systemPrompt .= "Docker & Container Management:\n";
