...
class AICrewManager:
    ...
    def __init__(self, distributed_router_instance, **kwargs):
        ...
        # **FIX:** Remove the "ollama/" prefix. LangChain's Ollama integration handles this.
        self.max_tokens = kwargs.get('max_tokens', config.model.max_tokens)
        self.provider = "ollama"  # Set the provider to "ollama" for clarity
        self.llm_config = {
    ...
    def _create_specialized_crew(self, category: str, inputs: Dict[str, Any]) -> Crew:
        ...
        if category == "research":
            ...
            # Correctly passing the single LLM instance
